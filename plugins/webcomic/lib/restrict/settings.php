...
function hook_add_age_media_state( array $states ) : array {
	$contexts = array_unique( (array) get_post_meta( get_the_ID(), 'webcomic_restrict_age_collection' ) );
...
function hook_add_roles_media_state( array $states ) : array {
	$contexts = array_unique( (array) get_post_meta( get_the_ID(), 'webcomic_restrict_roles_collection' ) );
...
function hook_add_password_media_state( array $states ) : array {
	$contexts = array_unique( (array) get_post_meta( get_the_ID(), 'webcomic_restrict_password_collection' ) );
